...
module.exports = function(buildConfig, defaults) {
    ...
    _.flatten(
      [
        ...
        "components/semantic/search/components/search",
        "components/semantic/search/components/date",
        "components/semantic/search/components/facet/slider",
        "components/semantic/search/web-components",
