...
public class FileUploadEndpoint {
    ...
    public Response createDocument(
        ...
        FileContainer fileContainer = (FileContainer) LDPImplManager.getLDPImplementation(FileContainer.IRI, Sets.newHashSet(LDP.Container, LDP.Resource), repositoryManager.getDefault());//ldp.getLDPResource(FileContainer.URI);
