 ...
 */
const registerElement = window.customElements.define;//document.registerElement;
...
export function renderWebComponent(
  ...
  templateScope = templateScope || TemplateScope.default.clone();
  ...
  if (component.propTypes) {
    ...
    if (propTypes.markupTemplateScope) {
      ...
      const scopeProps: Partial<ComponentProps> = {
        markupTemplateScope: fromNullable(templateScope),
      };
