...
import { ExtendedSearchValue } from '../../web-components/SemanticSearchApi';
import * as Model from './Model';
import { getCategoryTypes } from './ModelUtils';
import SearchProfileStore from '../profiles/SearchProfileStore';
import { generateSelectQuery } from './SparqlQueryGenerator';
