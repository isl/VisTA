...
import { SemanticFacetConfig } from '../config/SearchConfig';
import {
  DefaultFacetValueTemplate,
  DefaultFacetRelationsValuesQuery, DefaultFacetRelationTupleTemplate,
  DefaultFacetCategoriesValuesQuery, DefaultFacetCategoriesTupleTemplate,
} from '../config/Defaults';
import {
  FacetContext, FacetContextTypes,
} from './SemanticSearchApi';
import Facet from '../components/facet/Facet';
import { FacetStore, FacetData, Actions } from '../data/facet/FacetStore';
...
class SemanticSearchFacet extends Component<Props, State> {
  ...
  static defaultProps: Partial<SemanticFacetConfig> = {
    ...
    valueRelations: {},
    categories: {
      query: DefaultFacetCategoriesValuesQuery,
      tupleTemplate: DefaultFacetCategoriesTupleTemplate,
    },
    relations: {
      query: DefaultFacetRelationsValuesQuery,
  ...
  private createFacetStore(context: FacetContext & ComponentContext) {
    ...
    facetStore.getFacetData().onValue(facetData => {
      this.setState({
