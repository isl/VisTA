...
import {
  FieldValue, EmptyValue, AtomicValue, CompositeValue, ErrorKind, DataState, FinalizedModel,
} from './FieldValues';
 ...
 */
export class SemanticForm extends Component<Props, {}> {
  ...
  finalize(model: CompositeValue): FinalizedModel {
    return this.input.finalizeAsModel(FieldValue.empty, model);
  }
